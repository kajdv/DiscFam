...
PennController.GetTable( "_table-datasource-however_DiscFam.csv" ).setLabel("Expt");

PennController.FeedItems( PennController.GetTable( "_table-datasource-however_DiscFam.csv" ).filter("Expt","experiment"),
    (item) => PennController(
        newTimer("blank", 1000)
            .start()
            .wait()
